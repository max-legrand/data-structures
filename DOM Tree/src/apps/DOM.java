...
public class DOM {
	...
	static Scanner stdin = new Scanner(System.in).useDelimiter("\n");
	...
	static char getOption() {
		...
		while (response2.equals("")|| response2 == null || response2.equals("\n")) {
		
			response2 = stdin.nextLine();
		}
		char response = response2.toLowerCase().charAt(0);
